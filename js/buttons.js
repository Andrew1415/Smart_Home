...
var negative=["unlock","unlock","off","off","off","off","off","off","off","off","off","close","close","close","close", "off", "off", "off", "unlock", "off", "off", "unlock", "close", "off", "off", "off", "close", "off", "off","-n"];
